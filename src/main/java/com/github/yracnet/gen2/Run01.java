...
public class Run01 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String out = "/work/dev/bcb-01/r4/generate/mrp-portal/mrp-portal-view/src/main";
        File output = new File(out);
        String src = "/work/dev/bcb-01/r4/019-back/mrp-portal/mrp-portal-serv/src/main/java";
